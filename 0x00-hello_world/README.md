...
- Move the <span style="color:red">```betty```</span> file into ```/bin/``` directory or somewhere else in your ```$PATH``` with ```sudo mv betty /bin/```
...
<details>
<summary>8. UNIX is basically a simple operating system, but you have to be a genius to understand the simplicity</summary>
***
